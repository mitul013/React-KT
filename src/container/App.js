...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <button onClick={() => { this.setState({ cockpitFlag: !this.state.cockpitFlag }) }}>Change Cockpit</button>
        { this.state.cockpitFlag ?
          <Cockpit persons={this.state.persons} toggle={this.togglePerson}
